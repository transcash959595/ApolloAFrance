...
$con = mysqli_connect("","","","vssfr")or die ("could not connect to mysqli database");
$newname =$tablename;
...
$conFee = mysqli_connect("localhost","username","password","france")or die ("could not connect to mysqli database");
...
$CardSalesImport = 0;
$con = mysqli_connect("localhost","username","password","france")or die ("could not connect to mysqli database");
...
{
$con = mysql_connect("localhost","username","ankit");
if (!$con)
{
