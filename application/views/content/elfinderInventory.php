<script type="text/javascript">
  ...
  var serveraddr = $('#serveraddr').val();
    var elf = $('#elfinder').elfinder({
     ...
     url: 'http://'+ serveraddr +'/index.php/elfinderController/elfinder_/inventory'  // connector URL
...
<li class="listitemtittle"> <p class="paddtittle"><a href="<?php echo site_url('Customerservice/pageview/card-order-tool')?>"><img src="<?php echo base_url('/assets/images/ordercards.png')?>" alt="" class="imgheader" ></a>  </p></li>
