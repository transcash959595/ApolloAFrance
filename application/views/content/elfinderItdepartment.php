<script type="text/javascript">
  ...
  var serveraddr = $('#serveraddr').val();
    var elf = $('#elfinder').elfinder({
      ...
      url: 'http://'+ serveraddr +'/index.php/elfinderController/elfinder_/itdepartment'  // connector URL
...
<li class="listitemtittle"> <p class="paddtittle"><a href="<?php echo site_url('Account/phoneserver')?>"><img src="<?php echo base_url('/assets/images/phone.png')?>" alt="" class="imgheader" ></a>  </p></li>
