     ...
     <div class="container-fluid">
       ...
       <div class="row">
       	   <div class="col-lg-4 col-md-4 col-sm-4">
       	    ...
       	    <div class="col-lg-4 col-md-4 col-sm-4" >
       	   	 <a href="<?php echo site_url('Main')?>" target='_blank' > <img src="<?php echo base_url('/assets/images/home.png')?>" alt="" class="imgheader" style ='width: 40px; height: 40px;' > </a>
       	   </div>
       	    <div class="col-lg-4 col-md-4 col-sm-4" >
			<a href='<?php echo site_url('loginController/logout')?>'><img src="<?php echo base_url('/assets/images/logout.png')?>" alt='' class='imgheader'  style ='width: 40px; height: 40px;'></a>
