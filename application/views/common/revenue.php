...
<!-- header --> 
     <div class="container">
       ...
       <div class="row">
       	    ...
       	    <div class="col-lg-2 col-md-2 col-sm-1 thead"> <a href='<?php echo site_url('account/cardsales')?>' target='_blank'> Card Sold</a>  </div>
       	    <div class="col-lg-1 col-md-1 col-sm-1 thead"> <a href='<?php echo site_url('account/loading')?>' target='_blank'> Loading</a> </div>
       	    <div class="col-lg-2 col-md-2 col-sm-2 thead"> <a href='<?php echo site_url('account/interchangefees')?>' target='_blank'> Interchange & fees </a> </div>
       	    <div class="col-lg-1 col-md-1 col-sm-1 thead"> <a href='<?php echo site_url('account/misc')?>' target='_blank'>  Misc </a></div>
       	    <div class="col-lg-2 col-md-2 col-sm-2 thead"> <a href='<?php echo site_url('account/negbal')?>'  target='_blank'>Negative Balance  </a> </div>
