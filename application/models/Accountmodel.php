...
$queryGetRevenue = $this->db->get('revenuereport');

return  $queryGetRevenue->result();
...
public function getLoading($startdate,$enddate){
//$queryInsertLoading = $this->db->query('CALL loadingdetailed('.$startdate.','.$enddate.')');

$queryGetLoading = $this->db->get('revenueload');
return  $queryGetLoading->result();
